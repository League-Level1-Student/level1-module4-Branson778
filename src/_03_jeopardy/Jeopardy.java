...
JPanel panel = createHeader("My Chair");
...
sixthButton = createButton("$10000");
...
if(buttonPressed== firstButton) {
	askQuestion("Is My Seat Comfy?", "Totally", 200 );
...
if(buttonPressed == secondButton) {
	askQuestion("Is My Chair A SimRacing Chair?", "Yes", 400);
...
if(buttonPressed== thirdButton) {
	askQuestion("Is The Name Of My Chair PLAYSEAT?", "Yes", 600 );
	thirdButton.setText(null);
}
if(buttonPressed== fourthButton) {
	askQuestion("Does My Seat Have Wheels?", "Yes", 800 );
	fourthButton.setText(null);
}
if(buttonPressed== fifthButton) {
	askQuestion("Is My Seat Black With White Trim?", "Yes", 1000 );
	fifthButton.setText(null);
}
if(buttonPressed== sixthButton) {
	askQuestion("Is My Seat At My Gaming Computer?", "No", 10000 );
